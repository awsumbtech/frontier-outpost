export const MISSIONS = [
  // CH1: Planetfall
  { id: "m1a", chapter: "ch1", name: "Perimeter Sweep", desc: "Clear hostiles along the outpost perimeter", encounters: 2, tier: 1, xpMult: 1, recLevel: 1, environment: "crimson_clearing" },
  ...
  { id: "m1c", chapter: "ch1", name: "Eastern Ridge Patrol", desc: "Scout the ridge where movement was detected", encounters: 3, tier: 1, xpMult: 1.2, recLevel: 2, environment: "eastern_ridge" },
  ...
  { id: "m4a", chapter: "ch4", name: "Colony Defense", desc: "Hold the line as evolved creatures assault the colony", encounters: 5, tier: 3, xpMult: 3.0, recLevel: 7, environment: "colony_perimeter" },
